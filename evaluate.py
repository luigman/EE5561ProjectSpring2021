...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        fn_total = 0
        i = 0
        print("Evaluating F1 score for validation set:")
        ...
        for val_idx, val_data in enumerate(validation_loader):
            ...
            tp, fp, fn = IoU_masks(mask_vis, label_vis)
            #print(tp, fp, fn)
            tp_total += tp
            fp_total += fp
            fn_total += fn
            ...
            if i % 100 == 0:
                print("{} / 1388".format(i))
                prec_temp, recall_temp, f1_temp = measures(tp_total, fp_total, fn_total)
                print("Current F1 Score: ", f1_temp)
            ...
            #
            # plt.show()
        precision, recall, f1 = measures(tp_total, fp_total, fn_total)
